...
class BlogAccount(MainPageHandler):
	def render_front(self, template, **kw):
		...
		#logging.info("==> BlogAccount:render_front() cookie=" + str(username_cookie))
		if username_cookie:
...
app = webapp2.WSGIApplication(
                               [
                                ...
                                ('/unit6_ascii_w_cache/users',    		BlogUsers),
                                ('/unit6_ascii_w_cache/signup',   		BlogSignup),
                                ('/unit6_ascii_w_cache/welcome',        BlogWelcome),
                                ('/unit6_ascii_w_cache/login',          BlogLogin),
                                ('/unit6_ascii_w_cache/logout',         BlogLogout)
                                ],
                               debug=True)
